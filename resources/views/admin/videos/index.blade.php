        ...
        @foreach($rows as $row)
            ...
            <div class="card mb-4 col-12">
                ...
                <div class="card-body">
                    ...
                    <a class="btn btn-primary btn-rounded" href="{{ route('admin.videos.edit',$row->id) }}">{{ __('Edit Video') }}</a>
                    <a class="btn btn-primary btn-rounded" href="{{ route('admin.videos.show',$row->id) }}">{{ __('Delete Video') }}</a>
                </div>
            </div>
            </div>
        @endforeach
